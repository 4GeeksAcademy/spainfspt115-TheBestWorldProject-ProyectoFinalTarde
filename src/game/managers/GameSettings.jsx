export const GameSettings = {
  ...
  presets: {
    low: {
      effects: {
        fire: { flash: { enabled: false }, shake: { enabled: false }, particles: { quantity: 10 } },
        ice: { flash: { enabled: false }, shake: { enabled: false }, particles: { quantity: 10 } },
        lightning: { flash: { enabled: false }, shake: { enabled: false }, sparks: { quantity: 5 }, burst: { quantity: 3 }, strokeWidth: 3 }
      },
      animations: { enmies: { frameRate: 8, scale: 1.2 }, player: { frameRate: 8, scale: 1.2 } }
    },
    medium: {
      effects: {
        fire: { flash: { enabled: true }, shake: { enabled: false }, particles: { quantity: 20 } },
        ice: { flash: { enabled: true }, shake: { enabled: false }, particles: { quantity: 15 } },
        lightning: { flash: { enabled: true }, shake: { enabled: false }, sparks: { quantity: 15 }, burst: { quantity: 8 }, strokeWidth: 5 }
      },
      animations: { enmies: { frameRate: 12, scale: 1.3 }, player: { frameRate: 12, scale: 1.3 } }
    },
    high: { // CORRECCIÓN: "hight" -> "high"
      effects: {
        fire: { flash: { enabled: true }, shake: { enabled: true }, particles: { quantity: 40 } },
        ice: { flash: { enabled: true }, shake: { enabled: true }, particles: { quantity: 25 } },
        lightning: { flash: { enabled: true }, shake: { enabled: true }, sparks: { quantity: 25 }, burst: { quantity: 12 }, strokeWidth: 6 }
      },
